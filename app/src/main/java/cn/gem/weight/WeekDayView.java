...
public class WeekDayView extends View{
    ...
    private String[] weekString = new String[]{"选择","一","二","三","四","五","六","日"};
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(widthSize, heightSize+70);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(0, height+65, width, height+65, paint);
        ...
        for (int i=0;i < list.size();i++){
            ...
            int fontWidth = (int) paint.measureText(text);
            int startX = (columnWidth) * i + (columnWidth - fontWidth)/2;
            int startY = (int) ((height*2)/2 - (paint.ascent() + paint.descent())/2);
            if (i==6||i==7){
                paint.setColor(mWeekendColor);
            }else{
                paint.setColor(mWeedayColor);
