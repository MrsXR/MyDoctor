 ...
 */
public class MyReflashList extends ListView implements AbsListView.OnScrollListener {
   ...
   public static boolean   tag=false;//默认为false，为ListView的点击事件
    ...
    public MyReflashList(Context context) {
        this(context,null);
    }

    public MyReflashList(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public MyReflashList(Context context, AttributeSet attrs, int defStyleAttr) {
